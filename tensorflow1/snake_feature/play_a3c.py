...
from a3c_agent import preprocess

global episode
episode = 0
if not os.path.exists('save_graph/a3c_agent'):
    os.makedirs('save_graph/a3c_agent')
...
if __name__ == "__main__":
    ...
    for e in range(args.episode):
        ...
        state = preprocess(observe).reshape(agent.state_shape)
        ...
        while not done:
            ...
            next_state = preprocess(next_observe).reshape(agent.state_shape)
            if args.debug:
