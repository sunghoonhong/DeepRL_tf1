...
class A3CAgent:
        ...
        while True:
            ...
            if self.stats:
                ...
                print('%s: %s Episodes Trained! Reward:%.3f Step:%.3f Pmax:%.3f' 
                        ...
                        len(stats), mean[2], mean[1], mean[3]))
                stats = None
            else:
    ...
    def build_model(self):
        ...
        state_process = Dense(40, activation='elu')(state)
        state_process = BatchNormalization()(state_process)
        state_process = Dense(40, activation='elu')(state_process)
        state_process = BatchNormalization()(state_process)
        policy = Dense(self.action_size, activation='softmax')(state_process)
        value = Dense(1, activation='linear')(state_process)
        ...
        while True:
            ...
            while not done:
                ...
                if self.t >= self.t_max or done:
                    self.t = 0
                    actor_loss, critic_loss = self.train_model(next_state, done)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tmax',       type=int,   default=500,      help='Max length of trajectory')
