...
class PPOAgent:
    def __init__(self, state_size, action_size, seq_size,
                ...
                verbose, load_model, render, save_rate):
    ...
    def build_model(self, actor_only=False):
        ...
        state_process = Dense(32, activation='elu')(state)
        state_process = BatchNormalization()(state_process)
        state_process = Dense(32, activation='elu')(state_process)
        state_process = BatchNormalization()(state_process)
    ...
    def actor_optimizer(self):
        ...
        log_pi = K.log(K.sum(action * policy, axis=1) + 1e-10)
